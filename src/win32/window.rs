...
use windows::Win32::UI::WindowsAndMessaging::{CreateWindowExW, DefWindowProcW, RegisterClassW, CS_HREDRAW, CS_VREDRAW, CW_USEDEFAULT, WINDOW_EX_STYLE, WM_ACTIVATEAPP, WM_CREATE, WM_CLOSE, WM_DESTROY, WM_PAINT, WNDCLASSW, WS_OVERLAPPEDWINDOW, WS_VISIBLE, CREATESTRUCTW, SetWindowLongPtrW, GWLP_USERDATA, GetWindowLongPtrW};
use crate::App;
...
pub fn create_window(width: i32, height: i32, app: Pin<&App>) -> Result<HWND, &'static str> {
    ...
    let window: HWND = unsafe { CreateWindowExW(
        ...
        None,
        Some(h_instance),
        Some(app.get_ref() as *const App as *const std::ffi::c_void),
